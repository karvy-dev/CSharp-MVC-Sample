...
namespace AadhaarPortal.Models
{
    public class AesHelper
    {
        // encrypt methods

        #region encryptMethords
        ...
        public static string DecryptFromBase64String(string base64CipherText, byte[] Key, byte[] IV)
        {
            return DecryptFromBytes(Convert.FromBase64String(base64CipherText), Key, IV);
        }
